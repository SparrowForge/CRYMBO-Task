...
import i1 from "../../../public/whyChoose/1.svg";
import i2 from "../../../public/whyChoose/2.svg";
import i3 from "../../../public/whyChoose/3.svg";
import i4 from "../../../public/whyChoose/4.svg";
import i5 from "../../../public/whyChoose/5.svg";
import i6 from "../../../public/whyChoose/6.svg";
...
const Card = () => {
    ...
    return (
        <div className="flex flex-col justify-center xl:w-[1200px] md:gap-[60px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-[24px] lg:gap-[30px]">
                {data.map((card) => (
