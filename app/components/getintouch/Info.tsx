...
const Info = () => {
    return (
        <div className='flex justify-between items-center gap-20'>
            <div className="flex flex-col justify-between text-start text-[#FFFFFF]  gap-4 md:gap-[25px] items-start pl-4 md:pl-0">
                <div>
                    <button className='bg-[#F0FFF9]/15 py-2 px-4 rounded-full text-[16px]'>
                        Crypto payment gateway
                    </button>
                </div>
                <h1 className="hidden md:flex font-semibold  text-[#FFFFFF] text-4xl md:text-[56px] leading-[110.000001%]">Get in touch request <br />a demo today!</h1>
                <h1 className="flex md:hidden font-semibold  text-[#FFFFFF] text-4xl md:text-[56px] leading-[110.000001%]">Get in touch request a demo today!</h1>
            ...
            <div className='md:ml-32 hidden md:flex'>
