    ...
    return (
        <div className='flex justify-between items-center gap-20'>
            <div className="flex flex-col justify-between text-start text-[#FFFFFF]  gap-4 lg:gap-[25px] items-start pl-4 md:pl-0">
                ...
                <h1 className="hidden lg:flex font-semibold  text-[#FFFFFF] text-[56px] leading-[110.000001%]">Get in touch request <br />a demo today!</h1>
                <h1 className="flex lg:hidden font-semibold  text-[#FFFFFF] text-4xl md:text-[36px] leading-[110.000001%]">Get in touch request a demo today!</h1>
